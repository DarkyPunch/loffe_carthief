...
Config.dropoffPoints = { -- x,y,z = where you leave the vehicle, sx,sy,sz,sh = x,y,z for vehicle spawn + heading for vehicle
	...
	[5] = { x = -587.76, y = -1637.21, z = 19.89, sx = -1254.27, sy = -388.98, sz = 59.29, sh = 117.96, model = "entity2"},
	[6] = { x = -587.76, y = -1637.21, z = 19.89, sx = -2021.17, sy = -362.71, sz = 48.11, sh = 201.91, model = "italigto"}
